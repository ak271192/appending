# -*- coding: utf-8 -*-
"""
Created on Wed Jun 12 18:41:23 2019
...
person = "C:/Users/Dpotti/Pictures/Result/Person/mil1.jpg"
shirtopen = Image.open(shirt).convert("RGBA")
Personopen = Image.open(person).convert("RGBA")
background = Image.open(person).convert("RGBA")
Personopen.show()
shirtopen.show()
...
#    rhip = points[8]
#    print("rshoulder", rhip)
#    lhip = points[11]
#    print("lshoulder", lhip)
#    b = tuple(map(sub, lhip, rhip))
#    print(b)
#    rhip = points[8]
#    print("rshoulder", rhip)
#    rankle = points[10]
#    print("lshoulder", rankle)
#    l = tuple(map(sub, rhip, rankle))
#    print(l)
#    b,l = tuple(map(sub, b, l))
...
#    resized_mask1 = mask1.resize((b,l), Image.ANTIALIAS)
#    a1 = points[8]
#    b1 = (67,50)
